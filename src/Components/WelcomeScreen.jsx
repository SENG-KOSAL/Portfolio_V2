                ...
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  <div className="mb-2 sm:mb-4">
                    <span
                      data-aos="fade-right"
                      data-aos-delay="200"
                      className="inline-block px-2 bg-gradient-to-r text-transparent from-white via-blue-100 to-purple-200 bg-clip-text "
                    >
                      Welcome
                    </span>{" "}
                    <span
                  ...
                  <div>
                    <span
                      data-aos="fade-up"
                      data-aos-delay="800"
                      className="inline-block px-2 bg-gradient-to-r text-transparent from-indigo-600 to-purple-600 bg-clip-text "
                    >
                      Portfolio
                    </span>{" "}
                    <span
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text ">
                      <TypewriterEffect text="www.Seng.kosal" />
                    </span>
                  </div>
                </a>
              </motion.div>
